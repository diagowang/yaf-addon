...
abstract class AbstractModel
{
     ...
     * @return mixed
     */
    abstract public function insert($tableName, array $data, bool $isReturnLastInsertId = false);

    /**
     * 简单的更新数据，仅支持where条件是等于的情况
     * @param $tableName
     * @param array $data
     * @param array $where
     * @return int
     */
    abstract public function updateSimple($tableName, array $data, array $where);
     ...
     * @return int
     */
    abstract public function deleteSimple($tableName, array $where);
